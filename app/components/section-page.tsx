...
function Auctions({lang}:{lang:Lang}){
  ...
  const t=ui[lang]; const [brand,setBrand]=useState("Tous"); const [query,setQuery]=useState(""); const [visibleCount,setVisibleCount]=useState(AUCTION_PAGE_SIZE);
