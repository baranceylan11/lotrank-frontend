...
function Selection({lang}:{lang:Lang}){
  const {vehicles}=useAuctionVehicles();
  const t=ui[lang]; const [selected,setSelected]=useState<string[]>([fallbackVehicles[0].id,fallbackVehicles[2].id]);
